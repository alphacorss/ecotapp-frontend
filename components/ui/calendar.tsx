    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-gray-400 text-gray-600',
        ),
        ...
        day: cn(buttonVariants({ variant: 'ghost' }), 'h-9 w-9 p-0 font-[500] aria-selected:opacity-100 text-gray-600'),
        day_range_end: 'day-range-end',
        day_selected: 'bg-primary-300 text-white hover:bg-primary-300',
        ...
        day_range_middle: 'aria-selected:bg-gray-100 aria-selected:text-primary-300',
